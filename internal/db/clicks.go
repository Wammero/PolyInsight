...
func RegisterAlert(ctx context.Context, shortID, wallet, slug, marketURL string, chatID int64) error {
	_, err := DB.ExecContext(ctx,
		`INSERT INTO alert_clicks (short_id, chat_id, wallet, market_slug, market_url)
		 VALUES ($1, $2, $3, $4, $5) ON CONFLICT (short_id) DO NOTHING`,
		shortID, chatID, wallet, slug, marketURL)
	return err
}
